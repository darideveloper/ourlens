...
export default function AccessControl() {
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center px-4 bg-gradient-to-b from-brand-50 to-surface">
      <div className="w-full max-w-sm text-center mb-10 animate-fade-in">
        <img
